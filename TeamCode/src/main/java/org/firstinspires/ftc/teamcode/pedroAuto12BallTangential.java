...
@Autonomous(name="blueClose12BallPedroTangential", group = "Concept")
public class pedroAuto12BallTangential extends OpMode {
    ...
    private final Pose gate= new Pose(14.5,78.26415094339625,Math.toRadians(180));
    ...
    private final Pose collectSpikeTwoPose=new Pose(10,59.849056,Math.toRadians(180));
    ...
    private final Pose collectSpikeThreePose=new Pose (7.576767767676767676767,35.60377358490567,Math.toRadians(180));
    private final Pose spikeThreetoShootFourControlPoint=new Pose(58.877547169811315,83.24339622641509);
    ...
    public void buildPaths() {
        ...
        driveSpike3ToShoot4=follower.pathBuilder()
                .addPath(new BezierCurve(collectSpikeThreePose,spikeThreetoShootFourControlPoint,shootPoseFour))
                .setTangentHeadingInterpolation()
                .build();
...
//                }
            ...
            case DRIVE_SHOOT2_SPIKETWO:
                if (!follower.isBusy()){
                    ...
                    intake.setIntakePower(-1);
                    follower.followPath(driveCollectSpike2,1,true);
            ...
            case DRIVE_COLLECT_SPIKETHREE:
                if (!follower.isBusy()){
                    ...
                    //setPathState(PathState.DRIVE_TURNTOSHOOT4);
                    setPathState(PathState.DRIVE_SPIKETHREE_SHOOT4);
                }
                break;
            case DRIVE_TURNTOSHOOT4:
                if (!follower.isBusy()){
                    follower.turnTo(Math.toRadians(133));
                    setPathState(PathState.DRIVE_SPIKETHREE_SHOOT4);
                }
